  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Dark Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/80 via-[hsl(210,80%,25%)]/85 to-secondary/80" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-32">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span>Newly Launched December 2025 • Premium Services</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-white/85 max-w-3xl mx-auto mb-12 leading-relaxed"
          >
            Gintar Traders delivers professional plastering, painting, flooring, and 
            interior decoration with modern techniques and high-quality finishes.
          </motion.p>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="glass-card bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 text-center cursor-pointer hover:bg-white/20 transition-all"
              >
                <div className="text-3xl mb-2">{item.icon}</div>
                <div className="text-white font-display font-semibold">{item.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
