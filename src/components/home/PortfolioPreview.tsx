  ...
  return <section className="section-padding relative overflow-hidden">
      ...
      <div className="relative container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          delay: index * 0.1
        }} onMouseEnter={() => setHoveredId(project.id)} onMouseLeave={() => setHoveredId(null)} className="group relative rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500">
              {/* Image */}
              ...
              {/* Overlay */}
              <div className={`absolute inset-0 bg-gradient-to-t from-foreground via-foreground/60 to-transparent transition-opacity duration-300 ${hoveredId === project.id ? "opacity-100" : "opacity-0"}`} />
              ...
              {/* Content Overlay */}
              <div className={`absolute inset-0 flex flex-col justify-end p-6 transition-all duration-300 ${hoveredId === project.id ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
